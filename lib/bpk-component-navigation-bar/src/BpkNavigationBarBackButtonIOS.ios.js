...
const BpkNavigationBarBackButtonIOS = (props: Props): Node => {
  ...
  return (
    ...
    <TouchableOpacity
      ...
      {...rest}
    >
      {/* $FlowFixMe - Not sure why this errors, this seems correct according to the RN spec but doesn't like passing the string through. */}
      <Image
        source={chevron}
