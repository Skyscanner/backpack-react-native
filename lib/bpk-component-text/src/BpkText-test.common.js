...
const commonTests = () => {
  describe('BpkText', () => {
      ...
      const tree = renderer
        .create(
          <BpkText textStyle="xxxl">
            <BpkText textStyle="inherit">Some bold text</BpkText>
            Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Aenean
            commodo ligula eget dolor. Aenean massa. Cum sociis natoque
            penatibus et magnis dis parturient montes, nascetur ridiculus mus.
          </BpkText>,
    ...
    it('should render correctly when weight is set to inherit', () => {
      const tree = renderer
        .create(
          <BpkText textStyle="xxxl">
            <BpkText weight="emphasized">Some bold text</BpkText>
            Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Aenean
            commodo ligula eget dolor. Aenean massa. Cum sociis natoque
            penatibus et magnis dis parturient montes, nascetur ridiculus mus.
          </BpkText>,
