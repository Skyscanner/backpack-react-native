...
export const isWeightValid = (
  weight: string,
  textStyle: string,
): null | RegExp$matchResult | boolean =>
...
export const propTypes = {
  ...
  emphasize: (deprecated(PropTypes.bool, 'Use "weight" instead.'): any),
  style: stylePropType,
  textStyle: (PropTypes.oneOf(TEXT_STYLES): TextStyle),
  theme: themePropType,
