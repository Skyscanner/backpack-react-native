...
/**
 * Convert a date in the local time zone to UTC by discarding time zone
 * information. For example converts the date `1548298800` or
 * `2019-01-24T00:00:00-03:00` to `1548288000` or `2019-01-24T00:00:00Z` when
 * the local time zone is Brasilia Standard Time.
 * **Note:** This changes the underlying date, it's not just a time zone
 * conversion.
 *
 * This is the inverse of + (NSDate *)convertDateToLocal:(NSDate *)utcDate
 *                                         localCalendar:(NSCalendar
 * *)localCalendar utcCalendar:(NSCalendar *)utcCalendar;
 *
...
/**
 * Convert a date in UTC to the local time zone by discarding time zone
 information.
 * For example converts the date `1548288000` or `2019-01-24T00:00:00Z` to
 `1548298800` or `2019-01-24T00:00:00-03:00`
 ...
 * @return The same date in the local time zone with the timezone data
 discarded.
 */
