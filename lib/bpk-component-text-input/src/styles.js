...
const disabledColor = { light: textDisabledDay, dark: textDisabledNight };
const notFocusedColor = { light: textDisabledDay, dark: textDisabledNight };
const underlineColor = lineColor;
const placeholderColor = { light: textDisabledDay, dark: textDisabledNight };
const invalidColor = { light: textErrorDay, dark: textErrorNight };
...
const getLabelColorValue = (
  ...
  return valid === false
    ? unpackBpkDynamicValue(invalidColor, bpkAppearance)
    : unpackBpkDynamicValue(textPrimaryColor, bpkAppearance);
};
...
const getLabelStyle = (
  ...
  focusedColor: string | BpkDynamicValue<string> = textPrimaryColor,
  bpkAppearance: BpkAppearancePreferences,
) => {
...
const getInputContainerStyle = (
  ...
  hasAccessoryView: boolean,
  valid: ?boolean,
  focusedColor: string | BpkDynamicValue<string> = {
    light: coreAccentDay,
    dark: coreAccentNight,
  },
  bpkAppearance: BpkAppearancePreferences,
) => {
...
const getPlaceholderColor = (bpkAppearance: BpkAppearancePreferences) =>
  unpackBpkDynamicValue<typeof textPrimaryColor>(
    placeholderColor,
    bpkAppearance,
  );
