...
import { animationDurationSm } from '@skyscanner/bpk-foundations-react-native/tokens/base.react.native';
...
export const propTypes = {
  ...
  clearButtonMode: TextInputPropTypes.clearButtonMode,
...
const sanitizeMaskedValue = (value: ?string, mask: string) => {
...
export default withBpkAppearance<BpkTextConfig>(WithTheme);
