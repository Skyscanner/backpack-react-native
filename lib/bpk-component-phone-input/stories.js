...
const codes = [
  ...
  { id: 'IS', dialingCode: '+354', name: 'Iceland' },
  {
    id: 'IPTCS',
    dialingCode: '+991',
    name: 'International Telecommunications Public Correspondence Service trial (IPTCS)',
  },
...
storiesOf('bpk-component-phone-input/Integrated', module).add(
  'Full component example',
  () => <FullyIntegrated initiallySelectedId="CA" codes={codes} />,
);

storiesOf('bpk-component-phone-input/BpkDialingCodeList', module).add(
  'docs:dialing-code-list',
