...
const BpkPhoneNumberInput = (props: Props) => {
  const { renderFlag, dialingCode, editable, onDialingCodePress, ...rest } =
    props;
...
const { accessoryView: _thisIsIgnored, ...newTextInputPropTypes } =
  textInputPropTypes;
const { accessoryView: _thisIsAlsoIgnored, ...newTextInputDefaultProps } =
