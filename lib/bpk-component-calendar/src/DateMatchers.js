...
const range: (...dates: Array<?DateType>) => DateMatcher = createMacher(
  'range',
);
const after: (...dates: Array<?DateType>) => DateMatcher = createMacher(
  'after',
);
const before: (...dates: Array<?DateType>) => DateMatcher = createMacher(
  'before',
);
const any: (...dates: Array<?DateType>) => DateMatcher = createMacher('any');
