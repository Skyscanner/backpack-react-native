 ...
 */
export const colorBucketNegative = (
  days: DateMatcher,
): {
  __cellStyle: CellStyle,
  color: ?number,
 ...
 */
export const colorBucketNeutral = (
  days: DateMatcher,
): {
  __cellStyle: CellStyle,
  color: ?number,
 ...
 */
export const colorBucketPositive = (
  days: DateMatcher,
): {
  __cellStyle: CellStyle,
  color: ?number,
 ...
 */
export const colorBucketHighlight = (
  days: DateMatcher,
): | ColorBucket // eslint-disable-line prettier/prettier
  | {
      __cellStyle: CellStyle,
      color: ?number,
      days: DateMatcher,
