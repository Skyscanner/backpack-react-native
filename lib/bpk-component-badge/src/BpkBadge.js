...
const BpkBadge = (props: Props): Node => {
  const {
    accessoryView,
  ...
  const themeAttributes: {
    ...
    badgeDestructiveTextColor: string,
  } = {
    ...(getThemeAttributes(REQUIRED_THEME_ATTRIBUTES, theme): any),
  };
...
BpkBadge.propTypes = {
  ...
  docked: (PropTypes.oneOf(Object.keys(BADGE_DOCKED_TYPES)): any),
  message: PropTypes.string,
  style: ViewPropTypes.style,
  type: (PropTypes.oneOf(Object.keys(BADGE_TYPES)): any),
  theme: themePropType,
};
