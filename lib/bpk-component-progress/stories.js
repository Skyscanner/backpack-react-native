...
> {
  ...
  render() {
    ...
    // $FlowIgnore - Ignoring this error 'Cannot delete rest.initialValue because undefined is incompatible with number' - as the prop is required and would never be undefined
