...
import React, { Component, type AbstractComponent, type Config } from 'react';
...
export default (withBpkAppearance<BpkProgressConfig>(
  WithTheme,
): AbstractComponent<BpkProgressConfig>);
