...
const BpkThemeAttributes = (props: Props) => {
  ...
  console.warn(
    'BpkThemeAttributes will be removed on 31st December 2020. Migration guide: https://github.com/Skyscanner/backpack-react-native/blob/master/lib/bpk-theming/MIGRATION-BpkThemeAttributes.md',
  );
...
export default (withTheme(BpkThemeAttributes): ComponentType<any>);
