...
export const isValidTheme = (
  ...
  const numberOfRequiredAttributesSupplied =
...
export const makeThemePropType =
  (requiredAttributes: Array<string>, optionalAttributes?: Array<string>) =>
  (props: Object, propName: string, componentName: string): Error | boolean => {
    const { theme } = props;
