...
// TODO: Figure out the correct Element type
const BpkSelect = (props: Props): Element<any> => {
  const {
    disabled,
    focused,
    label,
...
BpkSelect.propTypes = {
  ...
  // Disabling as it pushes typecast to a new line that disagress with Flow
  // eslint-disable-next-line prettier/prettier
  label: (PropTypes.oneOfType([PropTypes.string, PropTypes.element]): String | Element<any>),
  style: ViewPropTypes.style,
  valid: (PropTypes.oneOf([true, false, null]): Boolean),
