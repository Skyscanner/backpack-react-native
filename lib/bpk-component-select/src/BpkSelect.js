...
const dynamicStyles = BpkDynamicStyleSheet.create({
  ...
  focused: {
    borderColor: { light: coreAccentDay, dark: coreAccentNight },
  },
  disabled: {
    borderColor: { light: surfaceHighlightDay, dark: surfaceHighlightNight },
  },
  selectContent: {
    marginEnd: 'auto',
  },
  ...
  selectImage: {
    ...
    backgroundColor: { light: canvasContrastDay, dark: canvasContrastNight },
    marginEnd: spacingMd,
  },
  validationMessage: {
    color: invalidColor,
