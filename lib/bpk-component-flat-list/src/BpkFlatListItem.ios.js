...
import React, { type Config, type AbstractComponent } from 'react';
import {
  spacingMd,
  spacingBase,
  spacingLg,
...
export default (withBpkAppearance<FlatListConfig>(
  WithTheme,
): AbstractComponent<FlatListConfig>);
