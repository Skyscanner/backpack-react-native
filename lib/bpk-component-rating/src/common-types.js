...
const arrayOrStringPropType: any = PropTypes.oneOfType([
  PropTypes.string,
...
export const propTypes = {
  ...
  size: (PropTypes.oneOf(Object.values(SIZES)): String),
  orientation: (PropTypes.oneOf(Object.values(ORIENTATION)): String),
};
