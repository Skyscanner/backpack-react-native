...
const commonTests = () => {
  describe('BpkButton', () => {
    it('should render correctly with required props', () => {
      const tree = renderer
        .create(<BpkButton title="Primary" type="primary" onPress={() => {}} />)
        .toJSON();
    ...
    it('should render large button correctly with required props', () => {
      const tree = renderer
        .create(
          <BpkButton title="Primary" type="primary" onPress={() => {}} large />,
        )
        .toJSON();
      expect(tree).toMatchSnapshot();
    });
    ...
    it('should render large icon only button correctly', () => {
      const tree = renderer
        .create(
          <BpkButton
            title="Primary"
