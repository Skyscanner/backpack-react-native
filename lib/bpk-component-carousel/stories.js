...
import { colorSkyGrayTint04 } from '@skyscanner/bpk-foundations-react-native/tokens/base.react.native';

import BpkImage, { withLoadingBehaviour } from '../bpk-component-image';
    ...
    <BpkCarousel accessibilityLabel={accessibilityLabel} style={styles.view}>
      ...
      <BpkCarouselItem>
        <WithLoadingBpkImage
          ...
          source={{
            uri: 'https://content.skyscnr.com/96508dbac15a2895b0147dc7e7f9ad30/canadian-rockies-canada.jpg',
          }}
        />
      </BpkCarouselItem>
    </BpkCarousel>
