...
(value6: Array<number | string>); // eslint-disable-line

const value7 = useBpkDynamicStyle({
  backgroundColor: { light: 'string', dark: 'string' },
});
(value7: { backgroundColor: string }); // eslint-disable-line

const value8 = useBpkDynamicStyle({
  backgroundColor: { light: 1, dark: 2 },
});
(value8: { backgroundColor: number }); // eslint-disable-line

const value9 = useBpkDynamicStyle({
  backgroundColor: { light: true, dark: false },
});
(value9: { backgroundColor: boolean }); // eslint-disable-line

const value10 = useBpkDynamicStyle({
  backgroundColor: { light: ['string'], dark: ['string'] },
});
(value10: { backgroundColor: string[] }); // eslint-disable-line

const value11 = useBpkDynamicStyle({
  backgroundColor: { light: [1], dark: [1] },
});
(value11: { backgroundColor: number[] }); // eslint-disable-line

const value12 = useBpkDynamicStyle({
  backgroundColor: { light: [true], dark: [true] },
});
(value12: { backgroundColor: boolean[] }); // eslint-disable-line
